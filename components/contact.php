                ...
                <div class="inner__content">
                  ...
                  <div class="content__block section-form-title">
                    <div class="block__descr">
                      <h2 class="reveal-type animate-in-up">Let’s Build Something!</h2>
                      <p class="h2__text text-twothirds type-basic-160lh animate-in-up">Got an idea, need a developer, or just want to say hi? Send me a message and I’ll get back to you faster than a fresh deploy.</p>
                    </div>
                  </div>
                      ...
                      <form action="../portfolio-react/php-logic/contact-query.php" method="POST" class="form contact-form" >
                        ...
                        <div class="container-fluid p-0">
                          <div class="row gx-0">
                            ...
                            <div class="col-12 form__item animate-in-up">
                              <button class="btn btn-default hover-default" type="submit" name="submit">
                                <em></em>
                            ...
                            <div class="content__block pre-grid-items">
                              ...
                              <div class="footer__link d-flex flex-column flex-md-row justify-content-md-between align-items-md-center">
                                ...
                                <div class="footer__btn animate-in-up">
                                  <a href="mailto:ahmedalvi229@gmail.com?subject=Message%20from%20your%20site" class="btn btn-circle-icon hover-circle">
                                    <em></em>
  ...
  <img src="img/logo.png" alt="Logo" class="logo-img">
                                  ...
                                  <div class="col-12 col-md-4 col-lg-3 contact-data__item grid-item">
                                    ...
                                    <p class="contact-data__text small type-basic-160lh">
                                      <a class="link-small-160lh animate-in-up" href="https://maps.app.goo.gl/qKM8WELDd1SSWXHSA" target="_blank">Clifton, Karachi, Pakistan</a>
                                    </p>
                                  </div>
                                  <div class="col-12 col-md-4 col-lg-3 contact-data__item grid-item">
                                    <p class="contact-data__title tagline-chapter animate-in-up">Phone</p>
                                    <p class="contact-data__text small type-basic-160lh">
                                      <a class="link-small-160lh animate-in-up" href="tel:+923112933137">+92 311 2933 137</a>
                                      <br>
                                      <a class="link-small-160lh animate-in-up" href="tel:+923112933137">+92 311 2933 137</a>
                                    </p>
                                  </div>
                                  <div class="col-12 col-md-4 col-lg-3 contact-data__item grid-item">
                                    ...
                                    <p class="contact-data__text small type-basic-160lh">
                                      <a class="link-small-160lh animate-in-up" href="mailto:ahmedalvi229@gmail.com?subject=Message%20from%20your%20site">ahmedalvi229@gmail.com</a>
